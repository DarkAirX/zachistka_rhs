ghst_c4_array = [];
player addAction ["<t size='1.2' shadow='2' color='#FEE093'>Attach C4</t> <img size='2' shadow='2' image='\A3\Weapons_F\Data\UI\gear_c4_charge_small_CA.paa'/>", {
...
player addAction [format ["<t size='1.2' shadow='2' color='#B22222'>Detonate C4 #%1</t> <img size='3' shadow='2' image='\A3\Weapons_F\Data\UI\gear_c4_charge_small_CA.paa'/>", _cn + 1], {
...
ghst_satchel_array = [];
player addAction ["<t size='1.2' shadow='2' color='#FEE093'>Attach Satchel</t> <img size='2' shadow='2' image='\A3\Weapons_f\data\UI\gear_satchel_CA.paa'/>", {
player playActionNow "PutDown";
...
player addAction [format ["<t size='1.2' shadow='2' color='#B22222'>Detonate Satchel #%1</t> <img size='3' shadow='2' image='\A3\Weapons_f\data\UI\gear_satchel_CA.paa'/>", _sn + 1], {
	_array = _this select 3;
		_explosive = _array select 0;
		_sn = _array select 1;
	player removeAction (_this select 2);
