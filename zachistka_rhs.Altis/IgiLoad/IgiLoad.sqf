...
if (isnil "IL_Variables") then
{
	...
	IL_Supported_Vehicles_VAN = ["C_Van_01_box_F", "B_G_Van_01_transport_F", "C_Hatchback_01_sport_F"];
	...
	IL_Supported_VAN = ["C_Van_01_box_F", "B_G_Van_01_transport_F", "C_Hatchback_01_sport_F"];
	...
	IL_Supported_Dixon2 = ["B_Heli_Light_01_F", "B_Heli_Light_01_armed_F", "B_Heli_Transport_01_F", "B_Heli_Attack_01_F", "B_Heli_Transport_01_camo_F", "O_Heli_Attack_02_F", "O_Heli_Attack_02_black_F", "I_Heli_light_03_F","RHS_Mi8mt_vvsc"];
	...
	IL_Supported_Cargo_Veh_HEMTT = IL_Supported_Cargo_Veh_Kamaz + IL_Supported_OFFROAD + IL_Supported_SUV + IL_Supported_Dixon2;
	...
	IL_Supported_Cargo_Veh_C130J = IL_Supported_Cargo_Veh_HEMTT + IL_Supported_Strider + IL_Supported_Hunter + IL_Supported_Ifrit + IL_Supported_Hummvee + IL_Supported_HEMTT + IL_Supported_Dixon + IL_Supported_Dixon1;
...
//	END IL_Init_Veh
	...
	IL_Init_Box =
	{
		...
		if (_obj_type in IL_Supported_Dixon) then
		{
			_obj setVariable["slots", 10, true];
			if (_obj_type == "B_APC_Wheeled_01_cannon_F") then
			{
				_obj setVariable["zload_cargo", 2.3, true];
			}
			else
			{
				_obj setVariable["zload_cargo", 2.25, true];
			};
			_obj setVariable["cargo_offset", 4, true];
		};
		if (_obj_type in IL_Supported_Dixon1) then
		{
			_obj setVariable["slots", 12, true];
			if (_obj_type == "B_MBT_01_TUSK_F") then
			{
				_obj setVariable["zload_cargo", 2.25, true];
			}
			else
			...
			_obj setVariable["cargo_offset", 5.5, true];
		};
		if (_obj_type in IL_Supported_Dixon2) then
		{
			_obj setVariable["slots", 6, true];
			if (_obj_type in ["B_Heli_Transport_01_F", "B_Heli_Light_01_armed_F", "I_Heli_light_03_F", "RHS_Mi8mt_vvsc"]) then
			{
			...
			else
			{
				...
				if (_obj_type in ["B_Heli_Light_01_F", "B_Heli_Transport_01_camo_F"]) then
				{
				...
				{
					if (_obj_type in ["B_Heli_Attack_01_F"]) then
					{
						_obj setVariable["zload_cargo", 1.4, true];
						_obj setVariable["cargo_offset", 2.4, true];
					}
					...
					{
						if (_obj_type in ["O_Heli_Attack_02_F", "O_Heli_Attack_02_black_F"]) then
						_obj setVariable["zload_cargo", 1.4, true];
						_obj setVariable["cargo_offset", 2.4, true];
					};
				};
