...
INS_REV_CFG_list_of_respawn_locations_blufor = ["BASE","UH80_1","ch67_1"];
INS_REV_CFG_list_of_respawn_locations_opfor = ["BASE","UH80_1","ch67_1"];
...
//
INS_REV_CFG_taw_view = false;	// Overrided by decription.ext parameter

// Squad Management
// Enable squad management
//
INS_REV_CFG_squad_management = false;	// Overrided by decription.ext parameter
